...
void saveHistory(char* buffer){
	FILE *filePointer;
	filePointer = fopen("/mnt/c/users/Anukool Dwivedi/Desktop/Sem6/CS307/assign1/command_history.txt","a");
	if(strlen(buffer)>0){
...
void showHistory(){
	FILE *filePointer;
	filePointer = fopen("/mnt/c/users/Anukool Dwivedi/Desktop/Sem6/CS307/assign1/command_history.txt","r");
